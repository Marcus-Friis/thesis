...
public class Miner implements Runnable {
  ...
  private static final long serialVersionUID = 0x00080000;
  ...
  {                             /* --- init. a substructure miner */
    ...
    if (args.length > 0) {      /* if no arguments are given */
      ...
      System.out.println(         "graph count support;");
      System.out.println("         excludes special extensions -R/-H)");
